...
typedef NSString *DingiExpressionInterpolationMode NS_TYPED_ENUM;
 ...
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiExpressionInterpolationMode DingiExpressionInterpolationModeLinear;
...
/**
 ...
 expression operator in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiExpressionInterpolationMode DingiExpressionInterpolationModeExponential;
...
/**
 ...
 expression operator in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiExpressionInterpolationMode DingiExpressionInterpolationModeCubicBezier;
...
/**
 ...
 @param curveType The curve type could be `DingiExpressionInterpolationModeLinear`,
 `DingiExpressionInterpolationModeExponential` and
 `DingiExpressionInterpolationModeCubicBezier`.
 @param parameters The parameters expression.
 @param stops The stops expression.
 */
+ (instancetype)mgl_expressionForInterpolatingExpression:(nonnull NSExpression*)inputExpression withCurveType:(nonnull DingiExpressionInterpolationMode)curveType parameters:(nullable NSExpression *)parameters stops:(nonnull NSExpression*)stops NS_SWIFT_NAME(init(forMGLInterpolating:curveType:parameters:stops:));
