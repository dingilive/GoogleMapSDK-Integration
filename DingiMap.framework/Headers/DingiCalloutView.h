...
@protocol DingiCalloutViewDelegate;
...
/**
 ...
 To receive updates from an object that conforms to the `DingiCalloutView` protocol,
 use the optional methods available in the `DingiCalloutViewDelegate` protocol.
 */
@protocol DingiCalloutView <NSObject>

/**
 An object conforming to the `MGLAnnotation` protocol whose details this callout
 view displays.
 */
@property (nonatomic, strong) id <DingiAnnotation> representedObject;
...
/**
 An object conforming to the `DingiCalloutViewDelegate` method that receives
 messages related to the callout view’s interactive subviews.
 */
@property (nonatomic, weak) id<DingiCalloutViewDelegate> delegate;
...
/**
 ...
 `-[DingiCalloutView presentCalloutFromRect:inView:constrainedToRect:animated:]`
...
/**
 The `DingiCalloutViewDelegate` protocol defines a set of optional methods that
 you can use to receive messages from an object that conforms to the
 `DingiCalloutView` protocol. The callout view uses these methods to inform the
 delegate that the user has interacted with the the callout view.
 */
@protocol DingiCalloutViewDelegate <NSObject>
 ...
 */
- (BOOL)calloutViewShouldHighlight:(UIView<DingiCalloutView> *)calloutView;

/**
 Tells the delegate that the callout view has been tapped.
 */
- (void)calloutViewTapped:(UIView<DingiCalloutView> *)calloutView;

/**
 Called before the callout view appears on screen, or before the appearance
 animation will start.
 */
- (void)calloutViewWillAppear:(UIView<DingiCalloutView> *)calloutView;

/**
 Called after the callout view appears on screen, or after the appearance
 animation is complete.
 */
- (void)calloutViewDidAppear:(UIView<DingiCalloutView> *)calloutView;
