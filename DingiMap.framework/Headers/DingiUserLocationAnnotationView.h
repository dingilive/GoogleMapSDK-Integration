...
/** View representing an `DingiUserLocation` on screen. */
MGL_EXPORT
 ...
 */
@property (nonatomic, readonly, weak, nullable) DingiMapView *mapView;
...
/**
 ...
 is inactive.
 */
@property (nonatomic, readonly, weak, nullable) DingiUserLocation *userLocation;
