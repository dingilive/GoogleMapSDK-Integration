...
@class DingiAnnotationView;
@class DingiAnnotationImage;
@class DingiUserLocation;
@class DingiPolyline;
@class DingiPolygon;
@class DingiShape;
@class DingiStyle;

@protocol DingiMapViewDelegate;
@protocol DingiAnnotation;
@protocol DingiOverlay;
@protocol DingiCalloutView;
@protocol DingiFeature;
@protocol DingiLocationManager;

/** Options for `DingiMapView.decelerationRate`. */
typedef CGFloat DingiMapViewDecelerationRate NS_TYPED_EXTENSIBLE_ENUM;

/** The default deceleration rate for a map view. */
FOUNDATION_EXTERN MGL_EXPORT const DingiMapViewDecelerationRate DingiMapViewDecelerationRateNormal;

/** A fast deceleration rate for a map view. */
FOUNDATION_EXTERN MGL_EXPORT const DingiMapViewDecelerationRate DingiMapViewDecelerationRateFast;

/** Disables deceleration in a map view. */
FOUNDATION_EXTERN MGL_EXPORT const DingiMapViewDecelerationRate DingiMapViewDecelerationRateImmediate;

/**
 The vertical alignment of an annotation within a map view. Used with
 `DingiMapView.userLocationVerticalAlignment`.
 */
typedef NS_ENUM(NSUInteger, DingiAnnotationVerticalAlignment) {
...
/**
 ...
 `DingiMapView.userTrackingMode`.
 */
typedef NS_ENUM(NSUInteger, DingiUserTrackingMode) {
    /** The map does not follow the user location. */
    DingiUserTrackingModeNone              = 0,
    /** The map follows the user location. This tracking mode falls back
        to `DingiUserTrackingModeNone` if the user pans the map view. */
    ...
    /**
        ...
        view, this tracking mode will fall back to `DingiUserTrackingModeFollow`.
     */
    ...
    /**
        ...
        this tracking mode will fall back to `DingiUserTrackingModeFollow`.
     */
    DingiUserTrackingModeFollowWithCourse,
};

/** Options for `DingiMapView.preferredFramesPerSecond`. */
typedef NSInteger DingiMapViewPreferredFramesPerSecond NS_TYPED_EXTENSIBLE_ENUM;

/**
 The default frame rate. This can be either 30 FPS or 60 FPS, depending on
 device capabilities.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiMapViewPreferredFramesPerSecond DingiMapViewPreferredFramesPerSecondDefault;

/** A conservative frame rate; typically 30 FPS. */
FOUNDATION_EXTERN MGL_EXPORT const DingiMapViewPreferredFramesPerSecond DingiMapViewPreferredFramesPerSecondLowPower;

/** The maximum supported frame rate; typically 60 FPS. */
FOUNDATION_EXTERN MGL_EXPORT const DingiMapViewPreferredFramesPerSecond DingiMapViewPreferredFramesPerSecondMaximum;
...
/**
 ...
 Using `DingiMapView`, you can embed the map inside a view, allow users to
 manipulate it with standard gestures, animate the map between different
 viewpoints, and present information in the form of annotations and overlays.

 The map view loads scalable vector tiles that conform to the DingiMap Vector Tile Specification.
 It styles them with a style that conforms to the
 DingiMap Style Specification.

 A collection of Dingi-hosted styles is available through the `DingiStyle`
 class.
 ...
 Because `DingiMapView` loads asynchronously, several delegate methods are available
 ...
 in the `DingiMapViewDelegate` protocol documentation.

 Adding your own gesture recognizer to `DingiMapView` will block the corresponding
 gesture recognizer built into `DingiMapView`. To avoid conflicts, define which
 gesture takes precedence. For example, you can create your own
 `UITapGestureRecognizer` that will be invoked only if the default `DingiMapView`
 tap gesture fails:
...
/**
 ...
 annotations.
 */
@property(nonatomic, weak, nullable) IBOutlet id<DingiMapViewDelegate> delegate;
...
/**
 ...
 `-[DingiMapViewDelegate mapViewDidFinishLoadingMap:]` method. It is not possible
 to manipulate the style before it has finished loading.

 @note The default styles provided by DingiMap contain sources and layers with
 ...
 */
@property (nonatomic, readonly, nullable) DingiStyle *style;

@property (nonatomic, readonly) NSArray<NSURL *> *bundledStyleURLs __attribute__((unavailable("Call the relevant class method of DingiStyle for the URL of a particular default style.")));
...
/**
 ...
 loaded but before loading a style associated with a different DingiMap account.
...
/**
 The DingiMap logo, positioned in the lower-left corner.

 @note The DingiMap terms of service, which governs the use of DingiMap-hosted
    vector tiles and styles requires most DingiMap
    customers to display the DingiMap logo. If this applies to you, do not
...
/**
 ...
 @note The DingiMap terms of service, which governs the use of DingiMap-hosted
    vector tiles and styles requires  these
    copyright notices to accompany any map that features DingiMap-designed styles,
    OpenStreetMap data, or other DingiMap data such as satellite or terrain
    data. If that applies to this map view, do not hide this view or remove
    any notices from it.

 @note You are additionally required
    ...
    setting elsewhere in your app or via `Settings.bundle`. See our website for
    implementation help.
 */
...
/**
 ...
 `DingiMapViewPreferredFramesPerSecondDefault`, which will adaptively set the
 preferred frame rate based on the capability of the user’s device to maintain
 a smooth experience.

 In addition to the provided `DingiMapViewPreferredFramesPerSecond` options, this
 property can be set to arbitrary integer values.

 @see `CADisplayLink.preferredFramesPerSecond`
 */
@property (nonatomic, assign) DingiMapViewPreferredFramesPerSecond preferredFramesPerSecond;
...
/**
 ...
 To receive the current user location, implement the `-[DingiMapViewDelegate mapView:didUpdateUserLocation:]`
 and `-[DingiMapViewDelegate mapView:didFailToLocateUserWithError:]` methods.
 
 If setting this property to `nil` or if no custom manager is provided this property
 is set to the default location manager.
 
 `DingiMapView` uses a default location manager. If you want to substitute your own
 ...
 */
@property (nonatomic, null_resettable) id<DingiLocationManager> locationManager;
 ...
 */
@property (nonatomic, readonly, nullable) DingiUserLocation *userLocation;

/**
 The mode used to track the user location. The default value is
 `DingiUserTrackingModeNone`.
 ...
 */
@property (nonatomic, assign) DingiUserTrackingMode userTrackingMode;
 ...
 */
- (void)setUserTrackingMode:(DingiUserTrackingMode)mode animated:(BOOL)animated;

/**
 The vertical alignment of the user location annotation within the receiver. The
 default value is `DingiAnnotationVerticalAlignmentCenter`.

 Changing the value of this property updates the map view with an animated
 transition. If you don’t want to animate the change, use the
 `-setUserLocationVerticalAlignment:animated:` method instead.
 */
@property (nonatomic, assign) DingiAnnotationVerticalAlignment userLocationVerticalAlignment __attribute__((deprecated("Use -[DingiMapViewDelegate mapViewUserLocationAnchorPoint:] instead.")));
 ...
 */
- (void)setUserLocationVerticalAlignment:(DingiAnnotationVerticalAlignment)alignment animated:(BOOL)animated __attribute__((deprecated("Use -[DingiMapViewDelegate mapViewUserLocationAnchorPoint:] instead.")));
...
/**
 ...
 `DingiUserTrackingModeFollowWithHeading` or
 `DingiUserTrackingModeFollowWithCourse`.
...
/**
 ...
 value other than `DingiUserTrackingModeFollowWithCourse`.
...
/**
 ...
 other than `DingiUserTrackingModeFollowWithCourse`.
...
/**
 ...
 Your application can use the `DingiMapViewDecelerationRateNormal` and
 `DingiMapViewDecelerationRateFast` constants as reference points for reasonable
 deceleration rates. `DingiMapViewDecelerationRateImmediate` can be used to
 ...
 */
@property (nonatomic) DingiCoordinateBounds visibleCoordinateBounds;
 ...
 */
- (void)setVisibleCoordinateBounds:(DingiCoordinateBounds)bounds animated:(BOOL)animated;
 ...
 */
- (void)setVisibleCoordinateBounds:(DingiCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated;
 ...
 */
- (void)showAnnotations:(NSArray<id <DingiAnnotation>> *)annotations animated:(BOOL)animated;
...
/**
 ...
 @param animated `YES` if you want the map region change to be animated, or `NO`
    if you want the map to display the new region immediately without animations.
 */
- (void)showAnnotations:(NSArray<id <DingiAnnotation>> *)annotations edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated;

/**
 A camera representing the current viewpoint of the map.
 */
@property (nonatomic, copy) DingiMapCamera *camera;
...
/**
 ...
 @param animated Specify `YES` if you want the map view to animate the change to
    ...
    immediately.
 */
- (void)setCamera:(DingiMapCamera *)camera animated:(BOOL)animated;
 ...
 */
- (void)setCamera:(DingiMapCamera *)camera withDuration:(NSTimeInterval)duration animationTimingFunction:(nullable CAMediaTimingFunction *)function;
 ...
 */
- (void)setCamera:(DingiMapCamera *)camera withDuration:(NSTimeInterval)duration animationTimingFunction:(nullable CAMediaTimingFunction *)function completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)setCamera:(DingiMapCamera *)camera withDuration:(NSTimeInterval)duration animationTimingFunction:(nullable CAMediaTimingFunction *)function edgePadding:(UIEdgeInsets)edgePadding completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(DingiMapCamera *)camera completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(DingiMapCamera *)camera withDuration:(NSTimeInterval)duration completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(DingiMapCamera *)camera withDuration:(NSTimeInterval)duration peakAltitude:(CLLocationDistance)peakAltitude completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @return A camera object centered on the same location as the coordinate
    ...
    direction and pitch.
 */
- (DingiMapCamera *)cameraThatFitsCoordinateBounds:(DingiCoordinateBounds)bounds;
...
/**
 ...
 @return A camera object centered on the same location as the coordinate bounds
    ...
    direction and pitch.
 */
- (DingiMapCamera *)cameraThatFitsCoordinateBounds:(DingiCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets;
 ...
 */
- (DingiMapCamera *)camera:(DingiMapCamera *)camera fittingCoordinateBounds:(DingiCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets;
 ...
 */
- (DingiMapCamera *)camera:(DingiMapCamera *)camera fittingShape:(DingiShape *)shape edgePadding:(UIEdgeInsets)insets;
 ...
 */
- (DingiMapCamera *)cameraThatFitsShape:(DingiShape *)shape direction:(CLLocationDirection)direction edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 If the `userTrackingMode` property is not `DingiUserTrackingModeNone`, the
 ...
 */
- (DingiCoordinateBounds)convertRect:(CGRect)rect toCoordinateBoundsFromView:(nullable UIView *)view;
...
/**
 ...
 @param view The view in whose coordinate system the returned rectangle should
    ...
    belong to the same window as the map view.
 */
- (CGRect)convertCoordinateBounds:(DingiCoordinateBounds)bounds toRectToView:(nullable UIView *)view;
...
/**
 ...
 `nil`.
 */
@property (nonatomic, readonly, nullable) NSArray<id <DingiAnnotation>> *annotations;

/**
 Adds an annotation to the map view.

 @note `DingiMultiPolyline`, `DingiMultiPolygon`, `DingiShapeCollection`, and
    `DingiPointCollection` objects cannot be added to the map view at this time.
 ...
 @param annotation The annotation object to add to the receiver. This object
    ...
    annotation object. */
- (void)addAnnotation:(id <DingiAnnotation>)annotation;

/**
 Adds an array of annotations to the map view.

 @note `DingiMultiPolyline`, `DingiMultiPolygon`, and `DingiShapeCollection` objects
    cannot be added to the map view at this time. Nor can `DingiMultiPoint`
    objects that are not instances of `DingiPolyline` or `DingiPolygon`. Any
 ...
 */
- (void)addAnnotations:(NSArray<id <DingiAnnotation>> *)annotations;
 ...
 */
- (void)removeAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (void)removeAnnotations:(NSArray<id <DingiAnnotation>> *)annotations;
 ...
 */
- (nullable DingiAnnotationView *)viewForAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (nullable __kindof DingiAnnotationImage *)dequeueReusableAnnotationImageWithIdentifier:(NSString *)identifier;
...
/**
 ...
 @return An annotation view object with the given identifier, or `nil` if no
    such object exists in the reuse queue.
 */
- (nullable __kindof DingiAnnotationView *)dequeueReusableAnnotationViewWithIdentifier:(NSString *)identifier;
 ...
 */
@property (nonatomic, readonly, nullable) NSArray<id <DingiAnnotation>> *visibleAnnotations;
...
/**
 ...
 @return An array of objects that adopt the `MGLAnnotation` protocol or `nil` if
    ...
    rectangle.
 */
- (nullable NSArray<id <DingiAnnotation>> *)visibleAnnotationsInRect:(CGRect)rect;
...
/**
 ...
 If the annotation is of type `DingiPointAnnotation` and is offscreen, the camera
 ...
 selected.
 */
@property (nonatomic, copy) NSArray<id <DingiAnnotation>> *selectedAnnotations;
...
/**
 ...
 | `YES`            | The annotation is selected, and the callout is presented. If the annotation is offscreen *and* is of type `DingiPointAnnotation`, the map is panned so that the annotation and its callout are brought just onscreen. The annotation is *not* centered within the viewport. |
 ...
 change the camera.
 */
- (void)selectAnnotation:(id <DingiAnnotation>)annotation animated:(BOOL)animated;
 ...
 */
- (void)deselectAnnotation:(nullable id <DingiAnnotation>)annotation animated:(BOOL)animated;
...
/**
 ...
 The objects in this array must adopt the `DingiOverlay` protocol. If no
 overlays are associated with the map view, the value of this property is
 empty array.
 */
@property (nonatomic, readonly, nonnull) NSArray<id <DingiOverlay>> *overlays;
...
/**
 ...
 @param overlay The overlay object to add. This object must conform to the
    `DingiOverlay` protocol. */
- (void)addOverlay:(id <DingiOverlay>)overlay;
...
/**
 ...
 @param overlays An array of objects, each of which must conform to the
    `DingiOverlay` protocol.
 */
- (void)addOverlays:(NSArray<id <DingiOverlay>> *)overlays;
 ...
 */
- (void)removeOverlay:(id <DingiOverlay>)overlay;
...
/**
 ...
 @param overlays An array of objects, each of which conforms to the `DingiOverlay`
    protocol.
 */
- (void)removeOverlays:(NSArray<id <DingiOverlay>> *)overlays;
 ...
 */
- (NSArray<id <DingiFeature>> *)visibleFeaturesAtPoint:(CGPoint)point NS_SWIFT_NAME(visibleFeatures(at:));
...
/**
 ...
 @return An array of objects conforming to the `DingiFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <DingiFeature>> *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:));
...
/**
 ...
 `DingiShapeSource` and `DingiVectorTileSource` objects but does not include
 anything from `DingiRasterTileSource` objects, or from video or canvas sources,
 which are unsupported by this SDK.

 The returned features are drawn by a style layer in the current style,
 ...
 `DingiFeature` object representing that bus stop is returned and its
 ...
 visibility, use the
 `-[DingiVectorTileSource featuresInSourceLayersWithIdentifiers:predicate:]` and
 `-[DingiShapeSource featuresMatchingPredicate:]` methods on the relevant sources.
 ...
 `visibleAnnotations` or `-[DingiMapView visibleAnnotationsInRect:]`.

 @note Layer identifiers are not guaranteed to exist across styles or different
    versions of the same style. Applications that use this API must first set
    the style URL to an explicitly versioned style using a convenience method
    like `+[DingiStyle outdoorsStyleURLWithVersion:]`, `DingiMapView`’s “Style URL”
 ...
 @return An array of objects conforming to the `DingiFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <DingiFeature>> *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:predicate:));
...
/**
 ...
 @return An array of objects conforming to the `DingiFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <DingiFeature>> *)visibleFeaturesInRect:(CGRect)rect NS_SWIFT_NAME(visibleFeatures(in:));
...
/**
 ...
 @return An array of objects conforming to the `DingiFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <DingiFeature>> *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:));
...
/**
 ...
 @return An array of objects conforming to the `DingiFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <DingiFeature>> *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:predicate:));
 ...
 */
@property (nonatomic) DingiMapDebugMaskOptions debugMask;
