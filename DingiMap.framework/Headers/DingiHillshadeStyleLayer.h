...
/**
 ...
 property.
 */
typedef NS_ENUM(NSUInteger, DingiHillshadeIlluminationAnchor) {
    /**
...
/**
 An `DingiHillshadeStyleLayer` is a style layer that renders raster <a
 ...
 loaded by an `DingiRasterDEMSource` object. For example, you could use a
 ...
 source, use an `DingiVectorTileSource` object in conjunction with several
 `DingiFillStyleLayer` objects.
...
*/
@property (nonatomic) DingiTransition hillshadeAccentColorTransition;
...
*/
@property (nonatomic) DingiTransition hillshadeExaggerationTransition;
...
*/
@property (nonatomic) DingiTransition hillshadeHighlightColorTransition;
 ...
 * Constant `DingiHillshadeIlluminationAnchor` values
...
/**
 ...
 `DingiHillshadeIlluminationAnchorViewport` and due north if
 `hillshadeIlluminationAnchor` is set to `DingiHillshadeIlluminationAnchorMap`.
...
*/
@property (nonatomic) DingiTransition hillshadeShadowColorTransition;
...
/**
 Creates a new value object containing the given `DingiHillshadeIlluminationAnchor` enumeration.

 @param hillshadeIlluminationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithDingiHillshadeIlluminationAnchor:(DingiHillshadeIlluminationAnchor)hillshadeIlluminationAnchor;

/**
 The `DingiHillshadeIlluminationAnchor` enumeration representation of the value.
 */
@property (readonly) DingiHillshadeIlluminationAnchor DingiHillshadeIlluminationAnchorValue;
