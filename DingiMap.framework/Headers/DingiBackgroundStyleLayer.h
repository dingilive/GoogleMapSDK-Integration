...
/**
 An `DingiBackgroundStyleLayer` is a style layer that covers the entire map. Use a
 ...
 other bodies of water are drawn by `DingiFillStyleLayer` objects.
 ...
 access it by getting the last item in the `DingiStyle.layers` array.
...
*/
@property (nonatomic) DingiTransition backgroundColorTransition;
...
*/
@property (nonatomic) DingiTransition backgroundOpacityTransition;
...
*/
@property (nonatomic) DingiTransition backgroundPatternTransition;
