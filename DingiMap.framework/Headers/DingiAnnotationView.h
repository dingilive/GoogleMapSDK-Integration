...
typedef NS_ENUM(NSUInteger, DingiAnnotationViewDragState) {
    /**
...
/**
 The `DingiAnnotationView` class is responsible for marking a point annotation
 with a view. Annotation views represent an annotation object, which is an
 object that corresponds to the `DingiAnnotation` protocol. When an annotation’s
 ...
 interactivity such as dragging, you can use an `DingiAnnotationImage` instead to
...
/**
 ...
 `-[DingiMapView dequeueReusableAnnotationViewWithIdentifier:]` method.
...
/**
 ...
 with views when views are provided to the map via the `-[DingiMapViewDelegate mapView:viewForAnnotation:]`
 method.
 ...
 @return The initialized annotation view object.
 */
- (instancetype)initWithAnnotation:(nullable id<DingiAnnotation>)annotation reuseIdentifier:(nullable NSString *)reuseIdentifier;
 ...
 */
@property (nonatomic, nullable) id <DingiAnnotation> annotation;
 ...
 */
@property (nonatomic, readonly) DingiAnnotationViewDragState dragState;
 ...
 */
- (void)setDragState:(DingiAnnotationViewDragState)dragState animated:(BOOL)animated NS_REQUIRES_SUPER;
