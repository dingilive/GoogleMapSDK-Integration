...
/**
 ...
 use the DingiShapeOfflineRegion class instead.
 */
MGL_EXPORT
@interface DingiTilePyramidOfflineRegion : NSObject <DingiOfflineRegion, NSSecureCoding, NSCopying>

/**
 The coordinate bounds for the geographic region covered by the downloaded
 tiles.
 */
@property (nonatomic, readonly) DingiCoordinateBounds bounds;
...
/**
 ...
 This is the designated initializer for `DingiTilePyramidOfflineRegion`.
 ...
 @param maximumZoomLevel The maximum zoom level to be covered by the downloaded
    ...
    level.
 */
- (instancetype)initWithStyleURL:(nullable NSURL *)styleURL bounds:(DingiCoordinateBounds)bounds fromZoomLevel:(double)minimumZoomLevel toZoomLevel:(double)maximumZoomLevel NS_DESIGNATED_INITIALIZER;
