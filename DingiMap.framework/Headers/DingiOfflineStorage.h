...
@class DingiOfflinePack;
@protocol DingiOfflineRegion;
@protocol DingiOfflineStorageDelegate;

/**
 Posted by the shared `DingiOfflineStorage` object when an `DingiOfflinePack`
 ...
 The `object` is the `DingiOfflinePack` object whose progress changed. The
 `userInfo` dictionary contains the pack’s current state in the
 `DingiOfflinePackStateUserInfoKey` key and details about the pack’s current
 progress in the `DingiOfflinePackProgressUserInfoKey` key. You may also consult
 the `DingiOfflinePack.state` and `DingiOfflinePack.progress` properties, which
 ...
 path.
 */
FOUNDATION_EXTERN MGL_EXPORT const NSNotificationName DingiOfflinePackProgressChangedNotification;

/**
 Posted by the shared `DingiOfflineStorage` object whenever an `DingiOfflinePack`
 ...
 The `object` is the `DingiOfflinePack` object that encountered the error. The
 `userInfo` dictionary contains the error object in the
 `DingiOfflinePackErrorUserInfoKey` key.
 */
FOUNDATION_EXTERN MGL_EXPORT const NSNotificationName DingiOfflinePackErrorNotification;

/**
 Posted by the shared `DingiOfflineStorage` object when the maximum number of
 tiles has been downloaded and stored on the current device.

 The `object` is the `DingiOfflinePack` object that reached the tile limit in the
 course of downloading. The `userInfo` dictionary contains the tile limit in the
 `DingiOfflinePackMaximumCountUserInfoKey` key.

 Once this limit is reached, no instance of `DingiOfflinePack` can download
 additional tiles from Dingi APIs until already downloaded tiles are removed by
 calling the `-[DingiOfflineStorage removePack:withCompletionHandler:]` method.
 Contact your Dingi sales representative to have the limit raised.
 */
FOUNDATION_EXTERN MGL_EXPORT const NSNotificationName DingiOfflinePackMaximumDingiTilesReachedNotification;

/**
 A key in the `userInfo` property of a notification posted by `DingiOfflinePack`.
 */
typedef NSString *DingiOfflinePackUserInfoKey NS_EXTENSIBLE_STRING_ENUM;
...
/**
 ...
 `DingiOfflinePackProgressChangedNotification` notification. Call `-integerValue`
 on the object to receive the `DingiOfflinePackState`-typed state.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiOfflinePackUserInfoKey DingiOfflinePackUserInfoKeyState;

FOUNDATION_EXTERN MGL_EXPORT NSString * const DingiOfflinePackStateUserInfoKey __attribute__((unavailable("Use DingiOfflinePackUserInfoKeyState")));
...
/**
 ...
 `DingiOfflinePackProgressChangedNotification` notification. Call
 `-DingiOfflinePackProgressValue` on the object to receive the
 `DingiOfflinePackProgress`-typed progress.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiOfflinePackUserInfoKey DingiOfflinePackUserInfoKeyProgress;

FOUNDATION_EXTERN MGL_EXPORT NSString * const DingiOfflinePackProgressUserInfoKey __attribute__((unavailable("Use DingiOfflinePackUserInfoKeyProgress")));
...
/**
 ...
 an `DingiOfflinePackErrorNotification` notification. The error’s domain is
 `DingiErrorDomain`. See `DingiErrorCode` for possible error codes.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiOfflinePackUserInfoKey DingiOfflinePackUserInfoKeyError;

FOUNDATION_EXTERN MGL_EXPORT NSString * const DingiOfflinePackErrorUserInfoKey __attribute__((unavailable("Use DingiOfflinePackUserInfoKeyError")));

/**
 The key for an `NSNumber` object that indicates the maximum number of
 Dingi-hosted tiles that may be downloaded and stored on the current device.
 This key is used in the `userInfo` dictionary of an
 `DingiOfflinePackMaximumDingiTilesReachedNotification` notification. Call
 `-unsignedLongLongValue` on the object to receive the `uint64_t`-typed tile
 limit.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiOfflinePackUserInfoKey DingiOfflinePackUserInfoKeyMaximumCount;

FOUNDATION_EXTERN MGL_EXPORT NSString * const DingiOfflinePackMaximumCountUserInfoKey __attribute__((unavailable("Use DingiOfflinePackUserInfoKeyMaximumCount")));
 ...
 */
typedef void (^DingiOfflinePackAdditionCompletionHandler)(DingiOfflinePack * _Nullable pack, NSError * _Nullable error);
 ...
 */
typedef void (^DingiOfflinePackRemovalCompletionHandler)(NSError * _Nullable error);
 ...
 */
typedef void (^DingiBatchedOfflinePackAdditionCompletionHandler)(NSURL *fileURL, NSArray<DingiOfflinePack *> * _Nullable packs, NSError * _Nullable error);

/**
 The type of resource that is requested.
 */
typedef NS_ENUM(NSUInteger, DingiResourceKind) {
    /** Unknown type */
 ...
 */
@property (class, nonatomic, readonly) DingiOfflineStorage *sharedOfflineStorage;
...
/**
 ...
 on the main queue.
 */
- (void)addContentsOfFile:(NSString *)filePath withCompletionHandler:(nullable DingiBatchedOfflinePackAdditionCompletionHandler)completion;
...
/**
 ...
 on the main queue.
 */
- (void)addContentsOfURL:(NSURL *)fileURL withCompletionHandler:(nullable DingiBatchedOfflinePackAdditionCompletionHandler)completion;
...
/**
 ...
 or endpoints.
 */
@property(nonatomic, weak, nullable) IBOutlet id<DingiOfflineStorageDelegate> delegate;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSArray<DingiOfflinePack *> *packs;
...
/**
 ...
 The pack has an initial state of `DingiOfflinePackStateInactive`. To begin
 downloading resources, call `-[DingiOfflinePack resume]` on the pack from within
 the completion handler. To monitor download progress, add an observer for
 `DingiOfflinePackProgressChangedNotification`s about that pack.
 ...
 */
- (void)addPackForRegion:(id <DingiOfflineRegion>)region withContext:(NSData *)context completionHandler:(nullable DingiOfflinePackAdditionCompletionHandler)completion;
 ...
 */
- (void)removePack:(DingiOfflinePack *)pack withCompletionHandler:(nullable DingiOfflinePackRemovalCompletionHandler)completion;

/**
 Forcibly, asynchronously reloads the `packs` property. At some point after this
 method is called, the pointer values of the `DingiOfflinePack` objects in the
...
/**
 ...
 `DingiOfflinePackMaximumDingiTilesReachedNotification` is posted for every
 ...
 @note The Dingi Terms of Service prohibits changing or bypassing this limit without permission from Dingi.
    Contact your Dingi sales representative to have the limit raised.
 */
...
/**
 ...
 as part of an offline pack or due to caching during normal use of `DingiMapView`.
 */
 ...
 */
- (NSURL *)offlineStorage:(DingiOfflineStorage *)storage
     URLForResourceOfKind:(DingiResourceKind)kind
                  withURL:(NSURL *)url;
