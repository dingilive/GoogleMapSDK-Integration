...
/**
 An `DingiMapCamera` object represents a viewpoint from which the user observes
 some point on an `DingiMapView`.
 */
MGL_EXPORT
...
/**
 ...
 @return A Boolean value indicating whether the two cameras are functionally
    equivalent.
 */
- (BOOL)isEqualToMapCamera:(DingiMapCamera *)otherCamera;
