...
/**
 The `DingiOverlay` protocol defines a specific type of annotation that represents
 ...
 */
@property (nonatomic, readonly) DingiCoordinateBounds overlayBounds;
 ...
 */
- (BOOL)intersectsOverlayBounds:(DingiCoordinateBounds)overlayBounds;
