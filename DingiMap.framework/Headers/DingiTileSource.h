...
@class DingiAttributionInfo;

/**
 Options for `DingiTileSource` objects.
 */
typedef NSString *DingiTileSourceOption NS_STRING_ENUM;
...
/**
 ...
 `DingiTileSourceOptionMaximumZoomLevel`, if specified. The default value for this
 option is 0.
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionMinimumZoomLevel;
...
/**
 ...
 The value should be between 0 and 22, inclusive, and less than
 `DingiTileSourceOptionMinimumZoomLevel`, if specified. The default value for this
 option is 22.
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionMaximumZoomLevel;

/**
 An `NSValue` object containing an `DingiCoordinateBounds` struct that specifies
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionCoordinateBounds;
...
/**
 ...
 `DingiTileSourceOptionAttributionInfos` option is specified, this option is
 ignored.
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionAttributionHTMLString;

/**
 An array of `DingiAttributionInfo` objects defining the buttons to be displayed
 ...
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionAttributionInfos;
#else
/**
...
/**
 ...
 the constants described in `DingiTileCoordinateSystem`.

 The default value for this option is `DingiTileCoordinateSystemXYZ`.

 This option corresponds to the `scheme` key in the
 <a href="https://github.com/mapbox/tilejson-spec/tree/master/2.1.0">TileJSON</a>
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionTileCoordinateSystem;

/**
 Tile coordinate systems that determine how tile coordinates in tile URLs are
 interpreted.
 */
typedef NS_ENUM(NSUInteger, DingiTileCoordinateSystem) {
    /**
     ...
     servers.
     */
    DingiTileCoordinateSystemXYZ = 0,
...
typedef NS_ENUM(NSUInteger, DingiDEMEncoding) {
    ...
    */
    DingiDEMEncodingMapbox = 0,

    /**
     Raster tiles generated with the [Mapzen Terrarium encoding formula](https://aws.amazon.com/public-datasets/terrain/).
    */
    DingiDEMEncodingTerrarium
};

/**
 `DingiTileSource` is a map content source that supplies map tiles to be shown on
 ...
 A tile source is added to an `DingiStyle` object along with one or more
 `DingiRasterStyleLayer` or `DingiVectorStyleLayer` objects. Use a style layer to
 ...
 Create instances of `DingiRasterTileSource` and `DingiVectorTileSource` in order
 to use `DingiTileSource`'s properties and methods. Do not create instances of
 `DingiTileSource` directly, and do not create your own subclasses of this class.
 */
MGL_EXPORT
...
/**
 An array of `DingiAttributionInfo` objects that define the attribution
 ...
 is loaded.
 */
@property (nonatomic, copy, readonly) NSArray<DingiAttributionInfo *> *attributionInfos;
