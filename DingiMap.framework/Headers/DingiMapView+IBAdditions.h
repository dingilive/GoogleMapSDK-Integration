...
@interface DingiMapView (IBAdditions)
...
// inspectables declared in DingiMapView.h are always sorted before those in
// DingiMapView+IBAdditions.h, due to ASCII sort order.
