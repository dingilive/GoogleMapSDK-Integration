...
/**
 ...
 This option is only applicable to `DingiRasterTileSource` objects; it is ignored
 when initializing `DingiVectorTileSource` objects.
 */
FOUNDATION_EXTERN MGL_EXPORT const DingiTileSourceOption DingiTileSourceOptionTileSize;

/**
 `DingiRasterTileSource` is a map content source that supplies raster image tiles
 ...
 A raster tile source is added to an `DingiStyle` object along with one or more
 `DingiRasterStyleLayer` objects. Use a raster style layer to control the
 ...
 `DingiRasterTileSource` object that you can use to initialize new style layers. You
...
/**
 ...
 `DingiTileSourceOptionTileSize` documentation for more information about tile
...
/**
 ...
 @param tileSize The width and height (measured in points) of each tiled image
    in the raster tile source. See the `DingiTileSourceOptionTileSize`
