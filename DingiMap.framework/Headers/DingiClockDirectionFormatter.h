...
/**
 The `DingiClockDirectionFormatter` class provides properly formatted descriptions
 ...
 irrespective of the user’s orientation, use `DingiCompassDirectionFormatter`
 instead.
 */
MGL_EXPORT
