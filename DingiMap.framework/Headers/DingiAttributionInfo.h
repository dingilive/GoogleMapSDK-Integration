 ...
 */
typedef NS_ENUM(NSUInteger, DingiAttributionInfoStyle) {
    /**
     Specifies a short attribution info style.
     */
    DingiAttributionInfoStyleShort = 1,
    /**
     Specifies a medium attribution info style.
     */
    DingiAttributionInfoStyleMedium,
    /**
     Specifies a long attribution info style.
     */
    DingiAttributionInfoStyleLong
};
...
/**
 ...
 @param zoomLevel The map’s zoom level. See the `DingiMapView.zoomLevel` property
...
/**
 ...
 Example: If the `style` property is set to `DingiAttributionInfoStyleShort` and the
 ...
 */
- (NSAttributedString *)titleWithStyle:(DingiAttributionInfoStyle)style;
