...
#import "DingiTypes.h"
#import "DingiCameraChangeReason.h"
...
/**
 The `DingiMapViewDelegate` protocol defines a set of optional methods that you
 can use to receive map-related update messages. Because many map operations
 require the `DingiMapView` class to load data asynchronously, the map view calls
 ...
 */
- (BOOL)mapView:(DingiMapView *)mapView shouldChangeFromCamera:(DingiMapCamera *)oldCamera toCamera:(DingiMapCamera *)newCamera;
 ...
 */
- (BOOL)mapView:(DingiMapView *)mapView shouldChangeFromCamera:(DingiMapCamera *)oldCamera toCamera:(DingiMapCamera *)newCamera reason:(DingiCameraChangeReason)reason;
 ...
 */
- (void)mapView:(DingiMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(DingiMapView *)mapView regionWillChangeWithReason:(DingiCameraChangeReason)reason animated:(BOOL)animated;
...
/**
 ...
 as `-[DingiMapView setCamera:animated:]`. This method can be called before
 ...
 */
- (void)mapViewRegionIsChanging:(DingiMapView *)mapView;
 ...
 */
- (void)mapView:(DingiMapView *)mapView regionIsChangingWithReason:(DingiCameraChangeReason)reason;
 ...
 */
- (void)mapView:(DingiMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(DingiMapView *)mapView regionDidChangeWithReason:(DingiCameraChangeReason)reason animated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(DingiMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(DingiMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(DingiMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(DingiMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(DingiMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(DingiMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(DingiMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapView:(DingiMapView *)mapView didFinishLoadingStyle:(DingiStyle *)style;
 ...
 */
- (void)mapViewWillStartLocatingUser:(DingiMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(DingiMapView *)mapView;
...
/**
 ...
 `DingiUserTrackingModeFollowWithHeading` and the heading changes, or if it is set
 to `DingiUserTrackingModeFollowWithCourse` and the course changes.
 ...
 */
- (void)mapView:(DingiMapView *)mapView didUpdateUserLocation:(nullable DingiUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(DingiMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
...
/**
 ...
 @param animated Whether the change caused an animated effect on the map.
 */
- (void)mapView:(DingiMapView *)mapView didChangeUserTrackingMode:(DingiUserTrackingMode)mode animated:(BOOL)animated;
...
/**
 ...
 This method will override any values set by `DingiMapView.userLocationVerticalAlignment`
 or `-[DingiMapView setUserLocationVerticalAlignment:]`.
 
 @param mapView The map view that is tracking the user's location.
 */
- (CGPoint)mapViewUserLocationAnchorPoint:(DingiMapView *)mapView;
 ...
 */
- (nullable DingiAnnotationImage *)mapView:(DingiMapView *)mapView imageForAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (CGFloat)mapView:(DingiMapView *)mapView alphaForShapeAnnotation:(DingiShape *)annotation;
 ...
 */
- (UIColor *)mapView:(DingiMapView *)mapView strokeColorForShapeAnnotation:(DingiShape *)annotation;
 ...
 */
- (UIColor *)mapView:(DingiMapView *)mapView fillColorForPolygonAnnotation:(DingiPolygon *)annotation;
 ...
 */
- (CGFloat)mapView:(DingiMapView *)mapView lineWidthForPolylineAnnotation:(DingiPolyline *)annotation;
 ...
 */
- (nullable DingiAnnotationView *)mapView:(DingiMapView *)mapView viewForAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (void)mapView:(DingiMapView *)mapView didAddAnnotationViews:(NSArray<DingiAnnotationView *> *)annotationViews;
 ...
 */
- (BOOL)mapView:(DingiMapView *)mapView shapeAnnotationIsEnabled:(DingiShape *)annotation;
 ...
 */
- (void)mapView:(DingiMapView *)mapView didSelectAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (void)mapView:(DingiMapView *)mapView didDeselectAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (void)mapView:(DingiMapView *)mapView didSelectAnnotationView:(DingiAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(DingiMapView *)mapView didDeselectAnnotationView:(DingiAnnotationView *)annotationView;
...
/**
 ...
 @return A Boolean value indicating whether the annotation should show a
    callout.
 */
- (BOOL)mapView:(DingiMapView *)mapView annotationCanShowCallout:(id <DingiAnnotation>)annotation;
...
/**
 ...
 @param annotation The object representing the annotation.
 @return A view conforming to the `DingiCalloutView` protocol, or `nil` to use the
    default callout view.
 */
- (nullable id <DingiCalloutView>)mapView:(DingiMapView *)mapView calloutViewForAnnotation:(id <DingiAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(DingiMapView *)mapView leftCalloutAccessoryViewForAnnotation:(id <DingiAnnotation>)annotation;
...
/**
 ...
 @return The accessory view to display.
 */
- (nullable UIView *)mapView:(DingiMapView *)mapView rightCalloutAccessoryViewForAnnotation:(id <DingiAnnotation>)annotation;
...
/**
 ...
 custom accessory views using the `DingiCalloutView` protocol’s
 ...
 */
- (void)mapView:(DingiMapView *)mapView annotation:(id <DingiAnnotation>)annotation calloutAccessoryControlTapped:(UIControl *)control;
...
/**
 ...
 `-[DingiCalloutViewDelegate calloutViewTapped:]` method.
 ...
 */
- (void)mapView:(DingiMapView *)mapView tapOnCalloutForAnnotation:(id <DingiAnnotation>)annotation;
